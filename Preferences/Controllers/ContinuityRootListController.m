#include "ContinuityRootListController.h"

@implementation ContinuityRootListController
...
- (NSMutableArray *)visibleSpecifiersFromPlist:(NSString *)plist {
    NSUserDefaults *preferences = [[NSUserDefaults alloc] initWithSuiteName:@"com.johnnywaity.continuity.preferences"];
